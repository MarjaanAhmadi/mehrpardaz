        ...
        <React.Fragment>
            {
                ...
                <div className={classes.root}>
                    ...
                    <span>Related Organization: {flight.related_organization !== undefined && flight.related_organization !== null ? flight.related_organization.id : '-'}</span>
                    <span>Related Aircraft Assignment: {flight.related_aircraft_assignment !== undefined && flight.related_aircraft_assignment !== null ? flight.related_aircraft_assignment.id : null}</span>
