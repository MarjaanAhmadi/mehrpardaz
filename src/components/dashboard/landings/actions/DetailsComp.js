        ...
        <React.Fragment>
            {
                ...
                <div className={classes.root}>
                    ...
                    <span>Related Organization: {landing.related_organization !== undefined && landing.related_organization !== null ? landing.related_organization._id : '-'}</span>
                    <span>Related Aircraft Assignment: {landing.related_aircraft_assignment !== undefined && landing.related_aircraft_assignment !== null ? landing.related_aircraft_assignment._id : null}</span>
