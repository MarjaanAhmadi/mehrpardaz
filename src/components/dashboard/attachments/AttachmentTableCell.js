...
const AttachmentTableCell = (props) => {
  ...
  const deleteAttachment = async () => {
    try {
      ...
      await Delete('attachments', props.data.data._id);
  ...
  const handleRequestClose = (idx) => {
    ...
    if(idx !== null) {
      switch(idx){
        case 0:
          ...
          props.deleteAttachment(props.data._id);
          //update
          break;
          default :
          break; 
    ...
    return (
      ...
      >
        ...
        <td>
          <div className="user-detail">
              <h5 className="user-name">{props.data.related_user!== null ? props.data.related_user.username : '-'} </h5>
            </div>
        </td>
        <td>
          <div className="user-detail">
