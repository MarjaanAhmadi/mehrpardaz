...
const GridImage = (props) => {
  ...
  switch (mediaList.length) {
    case 1:
      return (
        <div className="jr-gallery-item" onClick={handleToggle}>
          <img className="jr-img-fluid" src={mediaList[0].image} alt="post" />
        </div>
      );
    case 2:
      return (
        <div className="jr-gallery-grid jr-gallery-2" onClick={handleToggle}>
    ...
    case 3:
      return (
        <div className="jr-gallery-grid jr-gallery-3" onClick={handleToggle}>
          <div className="jr-gallery-item">
            <img className="jr-img-fluid" src={mediaList[0].image} alt="post" />
          </div>
          <div className="jr-gallery-item">
    ...
    case 4:
      return (
        <div className="jr-gallery-grid jr-gallery-4" onClick={handleToggle}>
          <div className="jr-gallery-item">
