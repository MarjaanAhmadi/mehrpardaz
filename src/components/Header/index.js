  ...
  Apps = () => {
    return (
      <ul className="jr-list jr-list-half">
        ...
        <li className="jr-list-item">
          <Link className="jr-list-link" to="/app/dashboard/flights">
            <i className="zmdi zmdi-check-square zmdi-hc-fw"/>
            <span className="jr-list-text"><IntlMessages id="sidebar.dashboard.flights"/></span>
          </Link>
        </li>
        <li className="jr-list-item">
          <Link className="jr-list-link" to="/app/dashboard/landings">
            <i className="zmdi zmdi-check-square zmdi-hc-fw"/>
            <span className="jr-list-text"><IntlMessages id="sidebar.dashboard.landings"/></span>
          </Link>
        </li>
        <li className="jr-list-item">
        ...
        <li className="jr-list-item">
          <Link className="jr-list-link" to="/app/dashboard/files">
            <i className="zmdi zmdi-check-square zmdi-hc-fw"/>
            <span className="jr-list-text"><IntlMessages id="sidebar.dashboard.files"/></span>
          </Link>
        </li>
        <li className="jr-list-item">
          <Link className="jr-list-link" to="/app/dashboard/attachments">
            <i className="zmdi zmdi-check-square zmdi-hc-fw"/>
            <span className="jr-list-text"><IntlMessages id="sidebar.dashboard.attachments"/></span>
          </Link>
        </li>
        {/* <li className="jr-list-item">
          <Link className="jr-list-link" to="/app/dashboard/fleets">
            <i className="zmdi zmdi-email zmdi-hc-fw"/>
            <span className="jr-list-text"><IntlMessages id="sidebar.dashboard.fleets"/></span>
          </Link>
        </li> */}
        </ul>)
  };
