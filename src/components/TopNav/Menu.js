            ...
            <ul className="sub-menu">
              ...
              <li className="nav-arrow">
                ...
                <ul className="sub-menu">
                  ...
                  {/* <li>
                    <NavLink className="prepend-icon" to="/app/dashboard/fleets">
                      <span className="nav-text"><IntlMessages id="sidebar.dashboard.fleets"/></span>
                    </NavLink>
                  </li> */}
                  ...
                  <li>
                    <NavLink className="prepend-icon" to="/app/dashboard/aircrafts">
                      <span className="nav-text"><IntlMessages id="
                      "/></span>
                    </NavLink>
                  </li>
                  <li>
              ...
              <li className="nav-arrow">
                ...
                <li>
                    <NavLink className="prepend-icon" to="/app/dashboard/fuel-and-weights">
                      <span className="nav-text"><IntlMessages id="sidebar.dashboard.fuelAndWeights"/></span>
                    </NavLink>
                  </li>
                  <li>
