...
export default class Downloader extends Component {
  ...
  async downloadFile() {
    const response = await Download('filemanager', this.props.fileId);
    debugger
  ...
  render() {
    const { children, className, style, fileId, fileName, fileExtension } = this.props;
                ...
                {fileExtension == ".pdf" ? (
                  ...
                  // : <p>{"Loading pdf file ..."}</p>
                    ...
                    fileExtension == ".png" || fileExtension == ".jpg" ?
                      ...
                      : <p>{`Unsupported format! \'${fileExtension}\'`}</p>
                  )
                }
              </ModalBody>
            </Modal>
