...
const FuelAndWeights = ({ match }) => {
  ...
  return (
    <div className="dashboard animated slideInUpTiny animation-duration-3">
      <ContainerHeader
        match={match}
        title={<IntlMessages id="sidebar.settings.fuelAndWeights" />}
      />
        ...
        <div className="col-12">
          <div className="jr-card">
            ...
            <FuelAndWeightTable
              ...
              getFuelAndWeights={getFuelAndWeights}
              data={fuelAndWeights.list}
            />
          </div>
        </div>
      </div>
      <Modal isOpen={previewVisible} toggle={handleCancel}>
        <ModalHeader toggle={handleCancel}>
          {edit ? "Edit Fuel And Weight" : "Create Fuel And Weight"}
        </ModalHeader>
        <ModalBody>
          <CreateOrEdit
            getFuelAndWeights={getFuelAndWeights}
