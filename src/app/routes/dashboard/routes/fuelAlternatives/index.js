...
const FuelAlternatives = ({match}) => {
    ...
    const getFuelAlternatives = async () => {
        try{
    ...
    return(
        <div className="dashboard animated slideInUpTiny animation-duration-3">
            <ContainerHeader match={match} title={<IntlMessages id="sidebar.settings.fuelAlternatives"/>}/>
            ...
            <Modal isOpen={previewVisible} toggle={handleCancel}>
                <ModalHeader toggle={handleCancel}>{edit ? 'Edit Fuel Alternative' : 'Create Fuel Alternative'}</ModalHeader>
                <ModalBody>
                    <CreateOrEdit getFuelAlternatives={getFuelAlternatives} id={editedId} edit={edit}/>
                </ModalBody>
            </Modal>
            <Modal isOpen={previewVisibleDetail} toggle={handleCancelDetail}>
                ...
                <ModalBody>
                    <LatestNotifications title="Fuel Alternative Details" detailId={detailId}/>
                </ModalBody>
            </Modal>
