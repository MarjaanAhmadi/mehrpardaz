...
const Landings = ({match}) => {
    ...
    const getLandings = async () => {
        try{
            ...
            const response = await List('landings', undefined, 10, 1, undefined, undefined);
    ...
    return(
        <div className="dashboard animated slideInUpTiny animation-duration-3">
            <ContainerHeader match={match} title={<IntlMessages id="sidebar.dashboard.landings"/>}/>
            ...
            <Modal isOpen={previewVisible} toggle={handleCancel}>
                <ModalHeader toggle={handleCancel}>{edit ? 'Edit Landingt' : 'Create Landingt'}</ModalHeader>
                <ModalBody>
